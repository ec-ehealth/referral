...
* extension[coprescriber].extension[coprescriber][=].extension[required].valueCodeableConcept = https://www.ehealth.fgov.be/standards/fhir/drp/CodeSystem/be-cs-co-prescriber-choice#one-of-mandatory
